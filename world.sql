# C:\xampp\mysql\bin\mysql -uroot < C:\Users\Korisnik\Documents\GitHub\Vjezba\world.sql
...
delete from country where Code='Cro';
...
values ('Cro','Croatia','Europe','Central Europe',100,1911,3900000,54.9,850,8900,'Hrvatska','Republic','Zoran Milanovic',null,'Cr');


insert into city (ID,Name,CountryCode,District,Population)
values (null,'Zagreb','HRV','Zagrebacka zupanija',1100000);

select * from City where CountryCode like 'HRV';

delete from City where ID=4081;

insert into city (ID,Name,CountryCode,District,Population)
values (null,'Djakovo','HRV','Osjecko baranjska',28000);

select * from countrylanguage where CountryCode like 'HRV';
update countrylanguage set language='Croatian' where CountryCode='HRV' and language='Serbo-Croatian';